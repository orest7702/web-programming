...
* використано html(5 версії) та css стилі для оформлення сторінок;
* реалізовано: 
  * семантичну розмітку;
  * навігаційне меню;
  * головну сторінку;
...
>Під час виконання лабораторної роботи №1 я укріпив практичні навички створення статичних web-сторінок. Також укріпив навички написання стилів.